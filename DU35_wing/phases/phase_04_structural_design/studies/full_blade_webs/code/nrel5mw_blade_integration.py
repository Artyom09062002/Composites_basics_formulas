...
PHASES_ROOT = Path(__file__).resolve().parents[4]
WIND_WING_ROOT = Path(__file__).resolve().parents[5]
REPO_ROOT = Path(__file__).resolve().parents[6]
RBS_CODE = PHASE4_ROOT / "studies" / "du35_rbs" / "code"
SANDWICH_CODE = PHASE4_ROOT / "studies" / "du35_sandwich" / "code"
for path in (REPO_ROOT, RBS_CODE, SANDWICH_CODE):
...
from composite_physics.sandwich_panel import assess_sandwich_panel


SESSION_ROOT = STUDY_ROOT
GEOMETRY_CSV = PHASES_ROOT / "phase_02_aerodynamics" / "data" / "reference_blade" / "blade_geometry.csv"
STATIONS_CSV = PHASE4_ROOT / "results" / "glass_station_results.csv"
PHASE4_SUMMARY_CSV = PHASE4_ROOT / "results" / "phase4_summary.csv"
STATIC_CSV = PHASES_ROOT / "phase_05_fea" / "results" / "phase5_static_cases.csv"
MODAL_CSV = PHASES_ROOT / "phase_05_fea" / "results" / "phase5_modal.csv"
BUCKLING_CSV = PHASES_ROOT / "phase_05_fea" / "results" / "phase5_panel_buckling.csv"
